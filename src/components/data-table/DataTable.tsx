...
const tableIcons: Partial<MRT_Icons> = {
  ArrowDownwardIcon: (props: React.SVGProps<SVGSVGElement>) => (
    <FuseSvgIcon
      size={20}
      {...(props as any)}
    >
  ...
  FilterListIcon: (props: React.SVGProps<SVGSVGElement>) => (
    <FuseSvgIcon
      size={16}
      {...(props as any)}
    >
  ...
  SortIcon: (props: React.SVGProps<SVGSVGElement>) => (
    <FuseSvgIcon
      size={20}
      {...(props as any)}
    >
  ...
  PushPinIcon: (props: React.SVGProps<SVGSVGElement>) => (
    <FuseSvgIcon
      size={20}
      {...(props as any)}
    >
...
function DataTable<TData extends MRT_RowData>(props: MaterialReactTableProps<TData>) {
  ...
  const tableOptions = useMemo(
    () => ({
      columns: columns || [], // Ensure columns is always defined
      data: data || [],
      ...defaults,
      ...rest
    }),
