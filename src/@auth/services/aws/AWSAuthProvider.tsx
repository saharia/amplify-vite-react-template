...
function AWSAuthProviderContent(props: FuseAuthProviderComponentProps & { ref?: Ref<FuseAuthProviderMethods> }) {
...
const AWSAuthProvider = forwardRef<FuseAuthProviderMethods, FuseAuthProviderComponentProps>(
