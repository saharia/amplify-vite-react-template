		...
		>
			<Box
				...
				sx={{
					...
					color: () => palette?.primary?.contrastText || (palette?.getContrastText ? palette.getContrastText(palette?.primary?.main || '#000000') : undefined)
				}}
			>
            ...
            color: () => palette?.secondary?.contrastText || (palette?.getContrastText ? palette.getContrastText(palette?.secondary?.main || '#000000') : undefined)
					}}
				>
					<span>S</span>
				</Box>
